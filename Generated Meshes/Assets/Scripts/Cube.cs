...
public class Cube : MonoBehaviour {
    [FormerlySerializedAs("XSize")] public int xSize;
    [FormerlySerializedAs("YSize")] public int ySize;
    [FormerlySerializedAs("ZSize")] public int zSize;
    private Mesh _mesh;
    ...
    private void Generate() {
        GetComponent<MeshFilter>().mesh = _mesh = new Mesh(); // this is interesting.
